#!/usr/bin/env bash
# ============================================================
#  FlashDiffusion — One-Command Environment Setup
# ============================================================
#
...
echo "=============================================="
echo "  FlashDiffusion Environment Setup"
echo "=============================================="
echo ""
...
echo ""
echo "Installing FlashDiffusion..."
...
python -c "
import sys, torch, numpy, cv2, PIL, diffusers, transformers
...
echo "    flashdiffusion generate --prompt 'a castle on a hill' --model sd15"
echo ""
echo "  Train LoRA:"
echo "    flashdiffusion train --model sd15 --data data/my_images --method lora"
echo ""
